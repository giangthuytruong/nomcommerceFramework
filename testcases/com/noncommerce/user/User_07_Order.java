...
public class User_07_Order extends BaseTest {
	...
	public void TC_02_EditProductShoppingCart() {
		...
		Assert.assertEquals(shoppingcartpage.getProductPrice(), "$1,300.00");
		Assert.assertEquals(shoppingcartpage.getQuantity(), "2");
		Assert.assertEquals(shoppingcartpage.getProductTotalPrice(), "$2,600.00");
	}
	@Test
	...
	public void TC_04_UpdateShoppingCart() {
		...
		shoppingcartpage=(ShoppingCartObject) homepage.openPageAtHeaderByName(driver, "ico-cart");
		Assert.assertEquals(shoppingcartpage.getQuantity(), "2");
		Assert.assertEquals(shoppingcartpage.getProductTotalPrice(), "$3,600.00");
		shoppingcartpage.inputQuantity("5");
		shoppingcartpage.clickToUpdateShoppingCart();
		Assert.assertEquals(shoppingcartpage.getQuantity(), "5");
		Assert.assertEquals(shoppingcartpage.getProductTotalPrice(), "$9,000.00");
	}
	@Test
	public void TC_05_Checkout_Order() {
		...
		Assert.assertEquals(shoppingcartpage.getSubTotalPrice(), "$9,000.00");
		...
		Assert.assertEquals(shoppingcartpage.getTotalPrice(), "$9,000.00");
		...
		checkoutpage.inputCity("Hanoi");
		checkoutpage.inputAddress1("123 Totenham");
		checkoutpage.inputZipPostalCode("10000");
		checkoutpage.inputPhoneNumber("0986222253");
		...
		checkoutpage.choosePaymentMethod("Check / Money Order");
